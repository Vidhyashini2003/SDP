        ...
        <div className="p-8">
            ...
            <div className="mb-6 flex gap-4 border-b border-slate-200">
                <button
                    ...
                    className={`pb-3 px-1 font-medium text-sm transition-colors relative ${activeTab === 'Pending' ? 'text-gold-600' : 'text-slate-500 hover:text-slate-700'}`}
                >
                    Pending Requests
                    {activeTab === 'Pending' && <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gold-600 rounded-t-full"></span>}
                </button>
                <button
                    onClick={() => setActiveTab('History')}
                    className={`pb-3 px-1 font-medium text-sm transition-colors relative ${activeTab === 'History' ? 'text-gold-600' : 'text-slate-500 hover:text-slate-700'}`}
                >
                    Refund History
                    {activeTab === 'History' && <span className="absolute bottom-0 left-0 w-full h-0.5 bg-gold-600 rounded-t-full"></span>}
                </button>
            </div>
